...
private fun overrideMixedPort(content: String, port: Int): String {
...
private suspend fun downloadConfigFile(
    context: Context,
    url: String,
    proxyAddress: String?,
    workDir: File,
...
private fun dumpLogFile(logFile: File, addLog: (String) -> Unit) {
