...
class MfcaM2mService : VpnService() {
    ...
    private fun establishTun(candidate: M2mCandidateState, artifacts: PreparedM2mArtifacts): ParcelFileDescriptor? =
        MfcaM2mTunHelper.establish(this, candidate, artifacts)
